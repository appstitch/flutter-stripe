#import "AppstitchStripePlugin.h"
#import <Stripe/Stripe.h>
#import "TPSStripeManager.h"


@implementation AppstitchStripePlugin
{
...
+ (void)registerWithRegistrar:(NSObject<FlutterPluginRegistrar>*)registrar {
    ...
    FlutterMethodChannel* channel = [FlutterMethodChannel methodChannelWithName:@"appstitch_stripe" binaryMessenger:[registrar messenger]];
    
    AppstitchStripePlugin* instance = [[AppstitchStripePlugin alloc] init];
