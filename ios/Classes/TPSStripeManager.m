...
NSString * const TPSAppInfoName = @"appstitch_stripe";
NSString * const TPSAppInfoPartnerId = @"appstitch_stripe";
NSString * const TPSAppInfoURL = @"https://github.com/appstitch/flutter-stripe";
