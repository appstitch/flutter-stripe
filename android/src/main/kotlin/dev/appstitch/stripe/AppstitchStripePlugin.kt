...
class AppstitchStripePlugin(private val stripeModule: StripeModule) : MethodCallHandler {
    ...
    companion object {
        ...
        fun registerWith(registrar: Registrar) {
            val channel = MethodChannel(registrar.messenger(), "appstitch_stripe")
            val stripeModule = StripeModule(registrar, registrar.activity())
            val plugin = AppstitchStripePlugin(stripeModule)
